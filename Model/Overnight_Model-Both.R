...
pdf("Best Models Overnight 2016-12-05.pdf", width = 11, height = 4.5)
...
points(Data$SELAllAC[Data$SiteType=="BCOvernight"], 
       jitter(Data$Annoy_SorMore[Data$SiteType=="BCOvernight"], factor = 0.2), 
     pch = 16, cex = 1.8, 
...
points(Data$SELAllAC[Data$SiteType=="BCOvernight"], 
       jitter(Data$Annoy_MorMore[Data$SiteType=="BCOvernight"], factor = 0.2), 
       pch = 16, cex = 1.8, 
...
points(Data$SELAllAC[Data$SiteType=="BCOvernight"], 
       jitter(Data$Annoy_VorMore[Data$SiteType=="BCOvernight"], factor = 0.2), 
       pch = 16, cex = 1.8, 
...
points(Data$SELAllAC[Data$SiteType=="BCOvernight"], 
       jitter(Data$IntWithNQ_SorMore[Data$SiteType=="BCOvernight"], factor = 0.2), 
       pch = 16, cex = 1.8, 
       col = alpha(colz2[1], 0.4))
...
points(Data$SELAllAC[Data$SiteType=="BCOvernight"], 
       jitter(Data$IntWithNQ_MorMore[Data$SiteType=="BCOvernight"], factor = 0.2), 
       pch = 16, cex = 1.8, 
       col = alpha(colz2[2], 0.4))
...
points(Data$SELAllAC[Data$SiteType=="BCOvernight"], 
       jitter(Data$IntWithNQ_VorMore[Data$SiteType=="BCOvernight"], factor = 0.2), 
       pch = 16, cex = 1.8, 
       col = alpha(colz2[3], 0.4))
