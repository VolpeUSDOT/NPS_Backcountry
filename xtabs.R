...
# Also, makes summary Table 1 for the report 
...
d <- read.csv("ATMP2011_CompleteDoseVars_dprime.csv")
...
colzbar4 = alpha(c("deepskyblue4", "dodgerblue4", "violet4","seagreen"), 0.8)
...
# d <- d[d$Survey != "AC",] # !!! Excluding audio clip surveys! This makes the number of data points almost line up with table from Amanda
